...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_case_4(self):
        self.assertEqual(Iterative([-4, -8, 2, -9, 10]), [-8, 2, -9, 10])
    ...
    def test_case_5(self):       
        self.assertEqual(Iterative([2, -4, 0, -4, -9, 6]), [-4, -9, 6])
